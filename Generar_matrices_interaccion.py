...
def Data_prep_1():
    ...
    result2 = result2.loc[result2.Consequence != "intergenic_variant"].drop(columns={"Consequence"}).drop_duplicates() ########################
...
result3["Score_fix"] = result3["IMPACT"] * (result3.Score +1) * (1-(result3.DISTANCE/5000)*0.9) * (1 + result3.DE_Score * result3.Consensus_DE_direction)
result3["Score2_fix"] = result3["IMPACT"] * (result3.Score2 +1) * (1-(result3.DISTANCE/5000)*0.9) * (1 + result3.DE_Score * result3.Consensus_DE_direction)
#######################################################################################################################################
...
result4["Score_fix"] = (500 * result4.Score_fix) + 1 
result4["Score2_fix"] = (500 * result4.Score2_fix) + 1 
...
rendimiento
#######################################################################################################################################
for amplif in [2,5,10,100]:
    print("\n"+ str(amplif))
    result4 = result3.copy()
    result4["Score_fix"] = (amplif * result4.Score_fix) + 1 
    result4["Score2_fix"] = (amplif * result4.Score2_fix) + 1 
    rendimiento = Evaluar_rendimiento()
    rendimiento
